...
echo "   🔸 Backend:  https://ec2-13-48-135-139.eu-north-1.compute.amazonaws.com (PID: $BACKEND_PID)"
echo "   🔸 Frontend: https://ec2-13-48-135-139.eu-north-1.compute.amazonaws.com (PID: $FRONTEND_PID)"
echo ""
echo "   ⚠️  Note: Using self-signed certificate - Accept browser security warning"
echo ""
echo "📝 Logs:"
