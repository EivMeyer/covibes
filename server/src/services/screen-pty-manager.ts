...
export class ScreenPtyManager extends EventEmitter implements TerminalManager {
  private sessions: Map<string, TerminalSession> = new Map();
  private readonly SESSION_PREFIX = 'colabvibe_';
  ...
  private setupPtyEventHandlers(agentId: string, ptyProcess: any) {
    ...
    ptyProcess.onExit(({ exitCode, signal }: { exitCode: number, signal: number | undefined }) => {
